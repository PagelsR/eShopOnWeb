-- CatalogDB.sql
-- eShopOnWeb Catalog Database Seeding Script
-- This script creates and seeds the catalog database with products, brands, and types
...
PRINT 'Catalog database seeded successfully';
GO
